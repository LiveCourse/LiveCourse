...
class Users extends REST_Controller
{
	...
	*/
	...
	{
		$this->db->update('lc_users',array('display_name' => 'Brandon and Darren TURD faces', 'password' => '3784fb671e6fab994a54645d9c266b3d7c5d48da'), array('display_name' => 'Lars Smellingson'));
		$name = $this->post('name');
