...
/**
 * 
 * The MainActivity can be said to be the main activity for our application, hence its name.
 * The swipy-tabs that allows the users to swip between the fragments is implemented here, the
 * fragments of the tabs are also use this activity as a base.
 */
public class MainActivity extends SherlockFragmentActivity implements OnPageChangeListener, OnRestCalled
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		/**
		 * Resumes state
		 * TODO: need to fix this later with a state machine in overall application
		 */
		...
		this.mAdapter 			= new TabsFragmentAdapter(	this.getSupportFragmentManager());
		
		this.mPager.setOffscreenPageLimit(					Globals.VIEW_PAGE_LOAD_COUNT);
		...
		this.registerReceiver(this.onComplete, 				new IntentFilter(DownloadManager.ACTION_DOWNLOAD_COMPLETE));
		this.registerReceiver(this.onNotificationClick, 	new IntentFilter(DownloadManager.ACTION_NOTIFICATION_CLICKED));
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		{
			/**
			 * Launches the settings menu activity
			 */
			case R.id.main_options_menu_settings:
				...
				break;
			/**
			 * Logs out the user, clears preferences
			 */
