...
public class UserInfoActivity extends SherlockFragmentActivity implements OnRestCalled, OnItemClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		/**
		 * The following code enlarges the picture and sets it The picture will
		 * take up the entire width of the screen and 1/4 of the screen height
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		switch (item.getItemId())
		{
			case R.id.userinfo_menu:
				...
				// Intent edituserInfo = new
				// Intent(this.getSherlockActivity(),UserInfoActivity.class);
	...
	public void onRestPostExecutionSuccess(String restCall, String result)
	{
		...
		if (restCall.equals(Restful.GET_SUBSCRIBED_SECTIONS_PATH))
		{
			...
			for (int i = 0; i < this.emptyAList.size(); i++)
				adapter.add(this.emptyAList.get(i));
